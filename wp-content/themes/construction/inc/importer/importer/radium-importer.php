   ...
   */
    ...
    public function demo_installer() {
        ...
        <div class="wrap about-wrap">
            <h2 style="text-transform: uppercase;letter-spacing: 2.5px;font-size: 28px;font-weight: bold;">One Click Demo Data Importer</h2>
                <div class="">
                    <p>Importing demo data (post, pages, images, theme settings, widgets, ...) is the easiest way to setup your theme. It will
                ...
                <br />
                <div>
                    <p><span style="color:#d54e21;font-weight: bold;">NOTE:</span> Before you begin, make sure all the <strong>required</strong> plugins are activated. ( It's recommended that you should install and active all <i>required</i> and <i>recommended</i> plugins before running demo data importer tool ).</p>
                </div>
                <br>
